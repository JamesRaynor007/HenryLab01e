...
df_monthly = dataframes.get('01-FuncionMes.csv')
df_daily = dataframes.get('02-FuncionDia.csv')
...
resultado_crew = dataframes.get('06-ResultadoCrewDirectores.csv')
data = dataframes.get('07-data_reduction.csv')
...
# Inicializar el vectorizador y calcular la matriz TF-IDF. Aquí tuve inconvenientes para iniciarlo luego de definir la app, por eso quedó antes de definir la misma.
...
def cantidad_filmaciones_mes(mes: str):
    ...
    <div>
        ...
        <img src="/images/cinta3.jpg" alt="Cinta" style="width:100%; -width:600px;"/>
    </div>
    """)
...
#No es requerido, puede ocasionar perdida de eficiencia, pero lo considero útil.
...
def get_titles():
    ...
    <html>
        ...
        <body>
            <h2>Titulos disponibles: (esperar 20 segundos para interactuar) </h2>
            {titulos_html}
...
#Funcionalidad extra: permite listar los actores que se pueden consultar.
...
def listar_actores():
    ...
    <html>
        ...
        <body>
            <p>Actores disponibles: (esperar 40 segundos para interactuar) </p>
            {actores_html}
...
def get_director(director_name: str):
    ...
    resultado_texto = (
        ...
        f"películas que no tienen retorno en este dataset.({total_zero_return})"                                                                    #Mención películas que no tienen el dato de retorno o el mismo es cero.
    )
...
#Funcionalidad extra: obtener la lista de directores disponibles para consultar.
...
def obtener_directores():
    ...
    <html>
        ...
        <body>
            <p>Directores disponibles: (esperar 15 segundos para interactuar) </p>
            {directores_html}
